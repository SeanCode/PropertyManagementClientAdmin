          ...
          <div class="box-body table-responsive no-padding">
            <table class="table table-hover">
              ...
              <tr v-for="article in articleList">
                ...
                <td><a href="javascript:void(0)" class="label label-primary" @click="goToEditArticle(article)">编辑</a></td>
  ...
  export default {
    ...
    methods: {
      ...
      goToAddArticle: function () {
        this.$route.router.go('/dashboard/home/article/add')
      },
      ...
      goToEditArticle: function (article) {
        this.$route.router.go('/dashboard/home/article/' + article.type + '/' + article.id)
      }
    }
  }
